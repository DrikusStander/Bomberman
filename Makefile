...
#    Updated: 2018/08/14 12:50:44 by cnolte           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS := source/main.cpp source/classes/Camera.class.cpp source/classes/Mesh.class.cpp source/classes/Shader.class.cpp source/classes/Model.class.cpp
OBJS := $(SRCS:.cpp=.o)
